export default function SongDetailsSkeleton() {
  return (
    <section className="song-shell py-10 sm:py-14" data-testid="song-details-skeleton" aria-busy="true" aria-label="Loading song details">
      <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-[minmax(240px,320px)_1fr] lg:gap-12">
        <div className="song-skeleton mx-auto aspect-square w-full max-w-72 rounded-2xl lg:max-w-none" />
